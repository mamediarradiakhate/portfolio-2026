  ...
  experience: [
    {
      ...
      bullets: [
        "Conception et développement solo d'une plateforme multi-agents IA (9 workflows N8N, 14 agents IA) pour automatiser le développement commercial de Kilifa Consulting, jusque-là entièrement porté par le dirigeant (mémoire de fin d'études)",
        "Moteur de veille des appels d'offres (opérationnel) : détecte 2x/jour les opportunités pertinentes sur BOAMP, France Travail et TED, sélectionne l'expert le plus adapté (score de matching 95/100), génère la lettre de motivation et prépare la candidature pour validation du dirigeant",
        "Moteur de prospection commerciale (développé) : identifie et qualifie chaque jour de nouveaux prospects B2B, envoie un premier email personnalisé, puis relance automatiquement selon un calendrier progressif (J+5/J+10/J+15) et analyse les réponses reçues",
        "CRM web de pilotage (Next.js) centralisant prospects, offres et candidatures en temps réel pour le dirigeant, avec rapport hebdomadaire automatique et supervision des erreurs des agents IA",
