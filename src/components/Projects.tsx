...
import { ExternalLink, X, CheckCircle2, Target, Lightbulb, TrendingUp } from "lucide-react";
...
function ProjectModal({ project, onClose }: { project: ProjectDetail; onClose: () => void }) {
  const blocks = [
    { icon: Target, label: "Problématique", content: project.challenge, color: "#db2777", bg: "#fdf2f8" },
    { icon: Lightbulb, label: "Solution", content: project.solution, color: "#0ea5e9", bg: "#f0f9ff" },
    { icon: TrendingUp, label: "Impact", content: project.impact, color: "#059669", bg: "#f0fdf4" },
  ];
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            {blocks.map((b) => (
              <div key={b.label} style={{ display: "flex", gap: "1rem", padding: "1rem 1.1rem", borderRadius: "14px", background: b.bg, border: `1px solid ${b.color}20` }}>
                <div style={{ width: "36px", height: "36px", borderRadius: "10px", background: `${b.color}15`, border: `1px solid ${b.color}25`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
